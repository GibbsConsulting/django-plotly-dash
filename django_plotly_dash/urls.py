...
urlpatterns = [
    ...
    path('instance/<slug:id>_dash-update-component',
         csrf_exempt(update), name="update-component"),
    path('instance/<slug:id>', main_view, name=main_view_label),
    path('instance/<slug:id>_dash-component-suites/<slug:component>/<resource>',
    ...
    path('app/<slug:id>_dash-dependencies',
         dependencies, {'stateless':True}, name="app-dependencies"),
    path('app/<slug:id>_dash-update-component',
    ...
    path('app/<slug:id>_dash-component-suites/<slug:component>/<resource>',
